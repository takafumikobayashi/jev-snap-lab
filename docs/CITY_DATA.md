...
`data/city/akitakata-2026-04-01.json` を次の手順で生成した。
...
**組織ページは下水道課と広島県水道広域連合企業団を1見出しにまとめている。** そのまま候補説明に使うと、下水道課の説明文に「水道料金」が含まれ、水道の問い合わせが市の課へ寄る。実際に下水道課69% / 企業団31% という誤った分布が出たため、説明文を境界で分割した。分割後は企業団100%になる。市の課と外部事業体を区別するという方針は、データの作り方まで含めて守る必要がある。
